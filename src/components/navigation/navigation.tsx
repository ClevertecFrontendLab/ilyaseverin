    ...
    <div className={styles.wrapper}>
      <div className={styles.left}>
        <div className={searchActiv ? styles.searchWrapper : ''}>
          <DebounceInput
            ...
            className={searchActiv ? styles.searchInputMobile : styles.searchInput}
          />
          <input
            data-test-id='button-search-close'
            type='submit'
            value=''
            className={searchActiv ? styles.closeInput : styles.none}
            onClick={() => setSearchActiv(false)}
          />
        </div>
        <button
          data-test-id='button-search-open'
          onClick={() => setSearchActiv((v) => !v)}
          className={searchActiv ? styles.none : styles.SearchButton}
          type='button'
        >
          {}
        </button>
        ...
        <button
          ...
          onClick={changeSort}
          className={searchActiv ? styles.none : styles.filterButtonSmall}
          type='button'
        >
          <img className={sort ? styles.reflection : ''} src={Action} alt='' />
          <p className={styles.filterButtonLarge}>По рейтингу</p>
        </button>
      </div>
      ...
      <div className={searchActiv ? styles.none : styles.right}>
        <button
          ...
          className={filter ? styles.gridButton : styles.burgerButton}
          type='button'
        >
