...
import { bookSelector } from '../../redux-saga/selectors';
...
export const BookPage: React.FC = () => {
    ...
    return <div role="presentation" onClick={() => setBurger(false)} style={burger ? { zIndex: 1 } : { zIndex: -1 }}>
            ...
            {book.isLoading === false &&
                ...
                <div className={styles.filling}>
                    <div className={styles.wrapper}>
                        <nav className={styles.headerText}> <NavLink to={`/books/${book.book.categories}`}>{book.book.categories}</NavLink>  / {book.book.title}</nav>
                    </div>
