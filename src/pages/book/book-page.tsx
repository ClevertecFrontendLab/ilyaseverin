            ...
            <div className={styles.bookContentWrapper}>
              ...
              <div className={styles.ratingWrapper}>
                ...
                <div className={styles.ratingText}>
                  {!book.book.rating ? <div className={styles.noRating}>ещё нет оценок</div> : book.book.rating}
                </div>
              </div>
              <div className={styles.boldText}>
              ...
              <button data-test-id='button-rating' className={styles.gradeButton} type='button'>
                Оценить книгу
              </button>
            </div>
          </div>
